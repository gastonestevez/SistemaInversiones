...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    @foreach ($usuarios as $usuario)
      ...
      <span>Total en billetera: ${{$usuario->billetera->total}}</span><br>
      <span>Invirtio: ${{$usuario->billetera->inversion_inicial}}</span><br>
      <span>Proyectos en los que invirtio:{{count($usuario->proyectos)}}</span><br>
      @foreach ($usuario->proyectos as $proyecto)
        <li class=""><span>{{$proyecto->titulo}}</span></li><br>
      @endforeach
      <br>
    @endforeach
