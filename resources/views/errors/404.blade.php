...
<html lang="en" dir="ltr">
  ...
  <div class="box__description">
    <div class="box__description-container">
      <div class="box__description-title">Ups!</div>
      <div class="box__description-text">Parece que no existe la página que estas buscando</div>
    </div>

    <a href="/prueba" target="_blank" class="box__button">Volver</a>
